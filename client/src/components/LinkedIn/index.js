...
//   }
  ...
  render() {
    ...
    return (
      ...
      <a href={`https://www.linkedin.com/oauth/v2/authorization?response_type=code&state=987654321&scope=r_liteprofile,r_emailaddress&client_id=78n1rxvat2k7ow&redirect_uri=https%3A%2F%2Fwww.reviewpanda.net%2F`}><LinkedInLoginButton align='center' style={{width:'200px'}}>
